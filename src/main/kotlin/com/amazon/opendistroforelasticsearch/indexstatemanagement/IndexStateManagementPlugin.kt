...
import com.amazon.opendistroforelasticsearch.indexstatemanagement.resthandler.RestRetryFailedManagedIndex
...
internal class IndexStateManagementPlugin : JobSchedulerExtension, ActionPlugin, Plugin() {
    ...
    override fun getRestHandlers(
        ...
        return listOf(
            ...
            RestRetryFailedManagedIndex(settings, restController)
        )
    }
